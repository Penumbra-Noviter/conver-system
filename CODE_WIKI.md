...
> 生成日期：2026-08-15
> 测试状态：<!--AUTO:tests_total:total-->2601<!--/AUTO--> 项全绿（pytest <!--AUTO:tests_total:pytest-->1180<!--/AUTO--> + Vitest <!--AUTO:tests_total:vitest-->1351<!--/AUTO--> + cargo test <!--AUTO:tests_total:cargo-->70<!--/AUTO-->）
>
...
### 4.14 `backend/app/services/chat.py` — 对话编排（<!--AUTO:lines:backend/app/services/chat.py-->~793 行<!--/AUTO-->）
...
三层测试体系：后端 pytest（26 文件）、前端 Vitest（33 文件）、壳 cargo test（4 集成文件 + lib.rs 单元）。覆盖率基线：后端 `pytest --cov`（目标 ≥90%）、前端 `npm run test:coverage`。
...
> 三层合计：**<!--AUTO:tests_total:total-->2601<!--/AUTO-->** 项全绿。
>
> - pytest（后端，含 1 skip）：<!--AUTO:tests_total:pytest-->1180<!--/AUTO-->
