...
### 4.14 `backend/app/services/chat.py` — 对话编排（<!--AUTO:lines:backend/app/services/chat.py-->~376 行<!--/AUTO-->）
...
| `backend/tests/test_regenerate.py` | <!--AUTO:tests:backend/tests/test_regenerate.py-->26<!--/AUTO--> | regenerate 端点（截断/事务/错误矩阵） |
