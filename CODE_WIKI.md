...
> 生成日期：2026-08-15
> 测试状态：<!--AUTO:tests_total:total-->1387<!--/AUTO--> 项全绿（pytest <!--AUTO:tests_total:pytest-->472<!--/AUTO--> + Vitest <!--AUTO:tests_total:vitest-->845<!--/AUTO--> + cargo test <!--AUTO:tests_total:cargo-->70<!--/AUTO-->）
...
| `frontend/tests/simulator-pc-css.test.js` | <!--AUTO:tests:frontend/tests/simulator-pc-css.test.js-->13<!--/AUTO--> | 模拟器 PC 覆盖层契约（验收标准 + F1/F2 回归锁） |
...
> 三层合计：**<!--AUTO:tests_total:total-->1387<!--/AUTO-->** 项全绿。
>
> - pytest（后端，含 1 skip）：<!--AUTO:tests_total:pytest-->472<!--/AUTO-->
> - Vitest（前端）：<!--AUTO:tests_total:vitest-->845<!--/AUTO-->
